 ...
 */
final class Version20220322102430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD packing INT NOT NULL, ADD packing_label VARCHAR(255) NOT NULL');
    }
